        ...
        if (event.phase == Phase.END
            ...
            if (stack != null && stack.getItem() == NaturesCompass.naturesCompass) {
                ...
                if (compass.getState(stack) == EnumCompassState.SEARCHING) {
                    ...
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.searching"), 5, 0, 0xAAAAAA, 1);
                    ...
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.status"), 5, 0, 0xFFFFFF, 0);
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.found"), 5, 0, 0xAAAAAA, 1);
                    ...
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.coordinates"), 5, 0, 0xFFFFFF, 6);
                    RenderUtils.drawLineOffsetStringOnHUD(
                            compass.getFoundBiomeX(stack) + ", " + compass.getFoundBiomeZ(stack), 5, 0, 0xAAAAAA, 7);

                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.distance"), 5, 0, 0xFFFFFF, 9);
                    RenderUtils.drawLineOffsetStringOnHUD(
                            String.valueOf(BiomeUtils.getDistanceToBiome(
                                    player, compass.getFoundBiomeX(stack), compass.getFoundBiomeZ(stack))),
                            5,
                            0,
                            0xAAAAAA,
                            10);
                    ...
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.status"), 5, 0, 0xFFFFFF, 0);
                    RenderUtils.drawLineOffsetStringOnHUD(
                            I18n.format("string.naturescompass.notFound"), 5, 0, 0xAAAAAA, 1);
